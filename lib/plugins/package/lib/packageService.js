...
module.exports = {
  ...
  packageService() {
    ...
    // run in series rather than boundless parallel, because esbuild is HEAVY
    // on RAM and will happily eat 16GB+ when running many builds in parallel
    BbPromise.mapSeries(allFunctions, functionName => {
      ...
      return BbPromise.resolve();
        ...
        return BbPromise.mapSeries(allLayers, layerName => {
